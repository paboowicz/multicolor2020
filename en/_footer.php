        ...
        <div class="row main-row">
            <div class="col-lg-6 d-flex flex-column justify-content-between">
                <div>
                    ...
                    <p class="par-1">Multicolor Printing House is <br> 
					a dynamically growing <br>family business.<br>
					We have operated on both <br>
					Polish and European markets <br>
					since 2004.   <br>
                        </p>
                </div>
            </div>
            <div class="col-lg-3">
                <p class="heading-3">COMPANY DATA</p>
                <p class="par-1">
            ...
            <div class="col-lg-3">
                ...
                <a href="#" class="par-1">biuro@multicolordrukarnia.pl</a>
                <a href="#" class="par-1 mb-0">+48 16 623 03 97</a>
                <a href="#" class="par-1">+48 516 055 622</a>
            </div>
        </div>
